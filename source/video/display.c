...
struct lcd_coordinate display_slice_area_320_240[18] = {
     //{ 0, 0, 0,0 },//reserve
...
void display_init()
{
	...
	uint8_t aidemo[] =   "Person Detect";

	lcd_impl_init(&s_lcd_impl);
	st7796_lcd_init(&s_lcd);
	display_window_clear();

	display_show_string(50U,  250, 200, 32, 32, mcxn9);
	display_show_string(50U,  280, 200, 32, 32, aidemo);
}
